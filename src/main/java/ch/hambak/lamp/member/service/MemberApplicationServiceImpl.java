...
import ch.hambak.lamp.member.entity.MemberStatus;
import ch.hambak.lamp.member.repository.AdminMemberRepository;
...
public class MemberApplicationServiceImpl implements MemberApplicationService {
    ...
    @Override
    @Transactional
    public void requestMembership(MemberCreateRequest createRequest) {
    ...
    @Override
    @Transactional
    public void approveMembership(String email) {
        AdminMember member = adminMemberRepository.findByEmailAndStatusPending(email)
                .orElseThrow(() -> new NoSuchElementException("pending member is not exist: %s".formatted(email)));
        member.approvePendingMember();
    }
